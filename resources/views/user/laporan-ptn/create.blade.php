...
<div class="page-header">
    ...
    <div class="d-block d-md-none position-absolute" style="right: 20px; top: 20px;">
        <a href="{{ route('user.laporan-ptn.index') }}">
        ...
        <div class="page-header-right-items">
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-md-block">
                    <a href="{{ route('user.laporan-ptn.index') }}" class="btn btn-icon btn-light-brand">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.laporan-ptn.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
