...
@section('title', 'Laporan Perguruan Tinggi Negeri')

@section('content')
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">Laporan PTN</h5>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard')}}">Menu Utama</a></li>
            <li class="breadcrumb-item">Laporan PTN</li>
        </ul>
    </div>
</div>
            ...
            <div class="card stretch stretch-full">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover" id="ptnTable">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode PT</th>
                                ...
                                <tr class="single-item">
                                    ...
                                    <td class="text-end">
                                        <div class="hstack gap-2 justify-content-end">
                                            <a href="{{ route('user.laporan-ptn.create', ['pt_uuid' => $pt->uuid]) }}" class="btn btn-sm btn-primary">
                                                <i class="feather-file-plus me-1"></i> Buat Laporan
                                            </a>
                                            <a href="{{ route('user.laporan-ptn.list', ['pt_uuid' => $pt->uuid]) }}" class="btn btn-sm btn-info">
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-2">Belum ada data Perguruan Tinggi Negeri yang aktif</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const ptnTable = $('#ptnTable').DataTable({
            responsive: true,
            language: {
                search: '_INPUT_',
