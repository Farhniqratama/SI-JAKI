...
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        ...
        <ul class="breadcrumb d-none d-md-flex">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('user.laporan-ptn.list', $laporan->perguruanTinggi->uuid) }}">Daftar Laporan</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{ route('user.laporan-ptn.detail', $laporan->uuid) }}">Detail</a>
            </li>
    ...
    <div class="d-block d-md-none position-absolute" style="right: 20px; top: 20px;">
        <a href="{{ route('user.laporan-ptn.detail', $laporan->uuid) }}">
        ...
        <div class="page-header-right-items">
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-md-block">
                    <a href="{{ route('user.laporan-ptn.detail', $laporan->uuid) }}" class="btn btn-icon btn-light-brand">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.laporan-ptn.update', $laporan->uuid) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4 d-flex justify-content-end gap-2">
                            <a href="{{ route('user.laporan-ptn.detail', $laporan->uuid) }}" class="btn btn-light">Batal</a>
