...
<div class="page-header">
    ...
    <div class="d-block d-md-none position-absolute" style="right: 20px; top: 20px;">
        <a href="{{ route('user.laporan-ptn.list', $laporan->perguruanTinggi->uuid) }}">
        ...
        <div class="page-header-right-items">
            <div class="d-flex align-items-center">
                <div class="d-none d-md-block">
                    <a href="{{ route('user.laporan-ptn.list', $laporan->perguruanTinggi->uuid) }}" class="btn btn-icon btn-light-brand">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('user.laporan-ptn.edit', $laporan->uuid) }}" class="btn btn-primary">
                            <i class="feather-edit me-2"></i> Edit Laporan
                        </a>
                        <form action="{{ route('user.laporan-ptn.destroy', $laporan->uuid) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')
