...
<div class="page-header">
    ...
    <div class="page-header-right ms-auto">
        <div class="page-header-right-items">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap page-header-right-items-wrapper">
                <a href="{{ route('manage-pt.create')}}" class="btn btn-primary">
                    <i class="feather-plus me-2"></i>
                    <span>Tambah Data PT</span>
                </a>

                <form action="{{ route('manage-pt.destroy-all') }}" method="POST" class="delete-all-form d-inline">
                    @csrf
                    @method('DELETE')
                                        ...
                                        <div class="hstack gap-2 justify-content-end">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="{{ route('histori-pt.detail', $pt->uuid) }}" class="dropdown-item">
                                                        <i class="feather-eye me-2"></i>Lihat Detail
                                                    </a>
                                                    <a href="{{ route('manage-pt.edit', $pt->uuid) }}" class="dropdown-item">
                                                        <i class="feather-edit me-2"></i>Edit
                                                    </a>
                                                    <div class="dropdown-divider"></div>
                                                    <form action="{{ route('manage-pt.destroy', $pt->uuid) }}" method="POST" class="d-inline delete-form">
                                                        @csrf
                                                        @method('DELETE')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const ptTable = $('#ptTable').DataTable({
            responsive: true,
            language: {
                search: '_INPUT_',
        ...
        // Konfirmasi Hapus Individual menggunakan event delegation
        $(document).on('submit', '.delete-form', function(e) {
            ...
            Swal.fire({
                title: 'Hapus data PT ini?',
                text: "Data perguruan tinggi dan laporan terkait akan dihapus permanen. Tindakan ini tidak bisa dibatalkan!",
                icon: 'warning',
        ...
        document.querySelectorAll('.delete-all-form').forEach(form => {
            form.addEventListener('submit', function(e) {
                e.preventDefault();
                Swal.fire({
                    title: 'Hapus semua data PT?',
                    text: 'Semua data perguruan tinggi dan laporan terkait akan dihapus permanen. Tindakan ini tidak bisa dibatalkan!',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#d33',
                    cancelButtonColor: '#3085d6',
